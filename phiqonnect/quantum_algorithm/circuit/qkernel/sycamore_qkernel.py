...
from phiqonnect.quantum_algorithm.circuit.data_encoding.sycamore import Sycamore

class Sycamore_QKernel(Qkernel):
	"""
	Sycamore_QKernel
	...
	def __init__(self, 
				...
				first_circuit = ["RZ", "RY"], 
				latter_cirrcuit = ["RZ"], 
				entanglement_gate = CXGate(),
				parameter_prefix: str = 'x',
				name: Optional[str] = 'sycamore') -> None:
		...
		base_qc = Sycamore(feature_dimension,
				num_qubits,
				first_circuit, 
				latter_cirrcuit, 
				entanglement_gate,
