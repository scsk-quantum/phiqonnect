...
from phiqonnect.quantum_algorithm.circuit.data_encoding.mps2 import MPS2

class MPS2_QKernel(Qkernel):
	"""
	MPS2_QKernel
	...
	def __init__(self, 
		...
		base_qc = MPS2(feature_dimension,
				num_qubits,
				first_circuit, 
				latter_cirrcuit, 
				entanglement_gate,
